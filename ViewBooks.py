...
def View():
	...
	headFrame.place(relx=0.25,rely=0.1,relwidth=0.5,relheight=0.13)
	Label(headFrame, text="View Books", bg='black', fg='white', font = ('Courier',15)).place(relx=0,rely=0, relwidth=1, relheight=1)
